...
public class EquationUtilsTest {
    ...
    @ArgumentsSource(AddEquationArgumentsProvider.class)
    ...
    static class AddEquationArgumentsProvider implements ArgumentsProvider {
        @Override
        public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
            return Stream.of(
                    Arguments.of(   new Equation(new Fraction[]{
